...
import static api.sikra.app.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import api.sikra.app.PojaGenerated;
import api.sikra.app.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "api.sikra.app.event1";
    return "api.sikra.app.event2";
  }
}
