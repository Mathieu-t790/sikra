package api.sikra.app.endpoint.event.consumer;

import api.sikra.app.PojaGenerated;
import api.sikra.app.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("api.sikra.app.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "api.sikra.app.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
